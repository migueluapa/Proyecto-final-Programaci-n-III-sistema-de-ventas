...
{
    public partial class Reporte_Categoria : Form
    {
        ...
        private void Reporte_Categoria_Load(object sender, EventArgs e)
        {
            categoria();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            factu = "SELECT *  FROM productos where categoria like'" + x + "'";
