...
namespace WindowsFormsApplication1
{
      ...
      
    {
        ...
        public void autogenerar()
        {
            ...
            string sql1 = "select id_compra  from  compras";
        ...
        private void Detallesss()
        {
            ...
            for (i = 0; i < dgDatos.Rows.Count - 1; i++)
            {
                ...
                sql = "insert into DETALLE_COMPRAS(ID_COMPRA,ID_PRODUCTO,DES_PRODUCTO,MARCA,PRECIO,CANTIDAD,IMPORTE) Values ('" + dgDatos.Rows[i].Cells[0].Value + "','" + dgDatos.Rows[i].Cells[1].Value + "','" + dgDatos.Rows[i].Cells[2].Value + "','" + dgDatos.Rows[i].Cells[3].Value + "','" + dgDatos.Rows[i].Cells[4].Value + "','" + dgDatos.Rows[i].Cells[5].Value + "','" + dgDatos.Rows[i].Cells[6].Value + "')";
...
txttotal.Text = "";
        ...
        private void cargardatoproveedor()
        {
        ...
        private void cargardatoproducto()
        {
            ...
            da = new SQLiteDataAdapter("select  productos.id_producto as codigo, productos.serie,productos.des_producto as producto,productos.compra_compra as p_compra,productos.stock_actual as stock,productos.marca,productos.categoria,productos.unidad_medida,productos.proveedor,productos.fecha_ingreso from productos", conexion);
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            SQLiteCommand cmd = new SQLiteCommand("insert into compras values(@id_compra,@tipo,@serie,@hora,@fecha,@proveedor,@sub_total,@igv,@total)", conexion);

            cmd.Parameters.Add(new SQLiteParameter("@id_compra", txtnumero.Text));
            ...
            cmd.Parameters.Add(new SQLiteParameter("@proveedor", txtproveedor.Text));
            ...
            MessageBox.Show("Asido Registrado de Compras ", "Correctamente", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            txtcodigo.Text = DataGridViewproveedor.CurrentRow.Cells["codigo"].Value.ToString();
            txtproveedor.Text = DataGridViewproveedor.CurrentRow.Cells["proveedor"].Value.ToString();



            txtdireccion.Text = DataGridViewproveedor.CurrentRow.Cells["direccion"].Value.ToString();

            txtruc.Text = DataGridViewproveedor.CurrentRow.Cells["ruc"].Value.ToString();
        ...
        {
            {
                ...
                string sql = "select  productos.id_producto as codigo, productos.serie,productos.des_producto as producto,productos.compra_compra as p_compra,productos.stock_actual as stock,productos.marca,productos.categoria,productos.unidad_medida,productos.proveedor,productos.fecha_ingreso from productos     WHERE des_producto like '" + TextBox1.Text + "%'";
        ...
        private void DataGridViewproducto_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtprecio.Text = DataGridViewproducto.CurrentRow.Cells["p_compra"].Value.ToString();
